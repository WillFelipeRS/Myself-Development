...
def jogadaMaquina(tabuleiro, jogada):
    ...
    if jogada == 2:
        if tabuleiro["A"][1] == "O" or tabuleiro["A"][2] == "O" or tabuleiro["C"][1] == "O" or tabuleiro["C"][2] == "O":
            tabuleiro["C"][0] = "X"
        
        elif tabuleiro["B"][0] == "O" or tabuleiro["C"][0] == "O" or tabuleiro["B"][2] == "O":
            tabuleiro["A"][2] = "X"
    ...
    if jogada == 3:
        # Casos em que o jogador começou pelos meios ou pelos cantos.
        # Tem de verificar se o jogador não fez missplay!
        if tabuleiro["C"][0] == "X" and tabuleiro["A"][1] == "O":
            if tabuleiro["B"][0] == "":
                tabuleiro["B"][0] = "X"
            else:
                tabuleiro["C"][2] = "X"
        elif tabuleiro["C"][0] == "X" and tabuleiro["A"][2] == "O":
            if tabuleiro["B"][0] == "":
                tabuleiro["B"][0] = "X"
            else:
                tabuleiro["C"][2] = "X"
        elif tabuleiro["C"][0] == "X" and tabuleiro["C"][1] == "O":
            if tabuleiro["B"][0] == "":
                tabuleiro["B"][0] = "X"
            else:
                tabuleiro["A"][2] = "X"
        elif tabuleiro["C"][0] == "X" and tabuleiro["C"][2] == "O":
            if tabuleiro["B"][0] == "":
                tabuleiro["B"][0] = "X"
            else:
                tabuleiro["A"][2] = "X"
        elif tabuleiro["B"][0] == "O" and tabuleiro["A"][2] == "X":
            if tabuleiro["A"][1] == "":
                tabuleiro["A"][1] = "X"
            else:
                tabuleiro["C"][2] = "X"
        elif tabuleiro["C"][0] == "O" and tabuleiro["A"][2] == "X":
            if tabuleiro["A"][1] == "":
                tabuleiro["A"][1] = "X"
            else:
                tabuleiro["C"][2] = "X"
        elif tabuleiro["B"][2] == "O" and tabuleiro["A"][2] == "X":
            if tabuleiro["A"][1] == "":
                tabuleiro["A"][1] = "X"
            else:
                tabuleiro["C"][0] = "X"
        # Casos em que o jogador começou pelo centro:
        elif tabuleiro["C"][0] == "O" and tabuleiro["B"][1] == "O" and tabuleiro["C"][2] == "X":
            tabuleiro["A"][2] = "X"
        elif tabuleiro["B"][1] == "O" and tabuleiro["A"][2] == "O" and tabuleiro["C"][2] == "X":
            tabuleiro["C"][0] = "X"
        elif tabuleiro["A"][1] == "O" and tabuleiro["B"][1] == "O" and tabuleiro["C"][2] == "X":
            tabuleiro["C"][1] = "X"
        elif tabuleiro["B"][0] == "O" and tabuleiro["B"][1] == "O" and tabuleiro["C"][2] == "X":
            tabuleiro["B"][2] = "X"
        elif tabuleiro["B"][1] == "O" and tabuleiro["C"][1] == "O" and tabuleiro["C"][2] == "X":
            tabuleiro["A"][1] = "X"
        else: # tabuleiro["B"][1] == "O" and tabuleiro["B"][2] == "O" and tabuleiro["C"][2] == "X"
            tabuleiro["B"][0] = "X"

    if jogada == 4:
        # Casos em que a máquina vai vencer:
        if tabuleiro["B"][0] == "O" and tabuleiro["C"][0] == "X" and tabuleiro["A"][1] == "O" and tabuleiro["C"][2] == "X":
            if tabuleiro["B"][1] == "":
                tabuleiro["B"][1] = "X"
            else:
                tabuleiro["C"][1] = "X"
        
        elif tabuleiro["B"][0] == "O" and tabuleiro["C"][0] == "X" and tabuleiro["A"][2] == "O" and tabuleiro["C"][2] == "X":
            if tabuleiro["B"][1] == "":
                tabuleiro["B"][1] = "X"
            else:
                tabuleiro["C"][1] = "X"
        
        elif tabuleiro["B"][0] == "O" and tabuleiro["C"][0] == "X" and tabuleiro["C"][1] == "O" and tabuleiro["A"][2] == "X":
            if tabuleiro["B"][1] == "":
                tabuleiro["B"][1] = "X"
            else:
                tabuleiro["A"][1] = "X"
        
        elif tabuleiro["B"][0] == "O" and tabuleiro["C"][0] == "X" and tabuleiro["A"][2] == "X" and tabuleiro["C"][2] == "O":
            if tabuleiro["B"][1] == "":
                tabuleiro["B"][1] = "X"
            else:
                tabuleiro["A"][1] = "X"
        
        elif tabuleiro["B"][0] == "O" and tabuleiro["A"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["C"][2] == "X":
            if tabuleiro["B"][1] == "":
                tabuleiro["B"][1] = "X"
            else:
                tabuleiro["B"][2] = "X"
        
        elif tabuleiro["C"][0] == "O" and tabuleiro["A"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["C"][2] == "X":
            if tabuleiro["B"][1] == "":
                tabuleiro["B"][1] = "X"
            else:
                tabuleiro["B"][2] = "X"
        
        elif tabuleiro["C"][0] == "X" and tabuleiro["A"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["B"][2] == "O":
            if tabuleiro["B"][1] == "":
                tabuleiro["B"][1] = "X"
            else:
                tabuleiro["B"][0] = "X"
        
        elif tabuleiro["C"][0] == "O" and tabuleiro["B"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["C"][2] == "X":
            if tabuleiro["A"][1] == "":
                tabuleiro["A"][1] = "X"
            else:
                tabuleiro["B"][2] = "X"
        
        elif tabuleiro["C"][0] == "X" and tabuleiro["B"][1] == "O" and tabuleiro["A"][2] == "O" and tabuleiro["C"][2] == "X":
            if tabuleiro["C"][1] == "":
                tabuleiro["C"][1] = "X"
            else:
                tabuleiro["B"][0] = "X"
        
        # Casos em que a máquina só vence por erro do jogador, senão o jogo tende ao empate:
        elif tabuleiro["A"][1] == "O" and tabuleiro["B"][1] == "O" and tabuleiro["C"][1] == "X" and tabuleiro["C"][2] == "X":
            if tabuleiro["C"][0] == "":
                tabuleiro["C"][0] = "X"
            else:
                tabuleiro["A"][2] = "X"
        
        elif tabuleiro["B"][0] == "O" and tabuleiro["B"][1] == "O" and tabuleiro["B"][2] == "X" and tabuleiro["C"][2] == "X":
            if tabuleiro["A"][2] == "":
                tabuleiro["A"][2] = "X"
            else:
                tabuleiro["C"][0] = "X"
        
        elif tabuleiro["A"][1] == "X" and tabuleiro["B"][1] == "O" and tabuleiro["C"][1] == "O" and tabuleiro["C"][2] == "X":
            if tabuleiro["A"][2] == "":
                tabuleiro["A"][2] = "X"
            else:
                tabuleiro["C"][0] = "X"
        
        else: # tabuleiro["B"][0] == "X" and tabuleiro["B"][1] == "O" and tabuleiro["B"][2] == "O" and tabuleiro["C"][2] == "X"
            if tabuleiro["C"][0] == "":
                tabuleiro["C"][0] = "X"
            else:
                tabuleiro["A"][2] = "X"
    ...
    if jogada == 5:
        # Casos em que a máquina só vence por erro do jogador, senão o jogo tende ao empate:
        if tabuleiro["C"][0] == "O" and tabuleiro["A"][1] == "O" and tabuleiro["B"][1] == "O" and tabuleiro["C"][1] == "X" and tabuleiro["A"][2] == "X" and tabuleiro["C"][2] == "X":
            if tabuleiro["B"][2] == "":
                tabuleiro["B"][2] = "X"
            else:
                tabuleiro["B"][0] = "X"
        
        elif tabuleiro["B"][0] == "O" and tabuleiro["C"][0] == "X" and tabuleiro["B"][1] == "O" and tabuleiro["A"][2] == "O" and tabuleiro["B"][2] == "X" and tabuleiro["C"][2] == "X":
            if tabuleiro["C"][1] == "":
                tabuleiro["C"][1] = "X"
            else:
                tabuleiro["A"][1] = "X"
        
        elif tabuleiro["C"][0] == "X" and tabuleiro["A"][1] == "X" and tabuleiro["B"][1] == "O" and tabuleiro["C"][1] == "O" and tabuleiro["A"][2] == "O" and tabuleiro["C"][2] == "X":
            if tabuleiro["B"][0] == "":
                tabuleiro["B"][0] = "X"
            else:
                tabuleiro["B"][2] = "X"
        
        else: # tabuleiro["B"][0] == "X" and tabuleiro["C"][0] == "O" and tabuleiro["B"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["B"][2] == "O" and tabuleiro["C"][2] == "X"
            if tabuleiro["A"][1] == "":
                tabuleiro["A"][1] = "X"
            else:
                tabuleiro["C"][1] = "X"
